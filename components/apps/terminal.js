...
export class Terminal extends Component {
    constructor() {
        ...
        this.child_directories = {
            root: ["books", "projects", "personal-documents", "skills", "languages", "Deep Learning", "interests"],
            PDPU: ["Hybrid Neural Networks"],
            books: ["Fooled by Randomness_Nassim Taleb.pdf", "The Mahabharata.pdf", "Econophysics Simplified.pdf", "The_Magic_of_Thinking_Big.pdf"],
            skills: ["LSTM", "CNN", "ANN", "TensorFlow ", "Pytorch", "mlFlow", "Keras"],
            projects: ["tamilselvam-personal-portfolio", "PDF GPT", "Galactica Fine Tuned", "Fusion GPT", "Portfolio Optimization Recurrent RL", "FinPortRL", "Random Numbers"],
            interests: ["Deep Learning", "Mathematical Optimization", "Algorithmic Trading","Databricks","Clickhouse"],
        ...
        return (
            <React.Fragment key={id}>
                <div className="flex w-full h-5">
                    <div className="flex">
                        <div className=" text-ubt-green">tamilselvam@Lenovo</div>
        ...
        switch (main) {
            ...
            case "code":
                if (words[0] === "." || words.length === 0) {
                    ...
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands:[ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-tamilselvam, todoist, trash, settings, sendmsg]";
                }
                break;
            case "echo":
            ...
            case "about-vivek":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("about-tamilselvam");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands: [ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-tamilselvam, todoist, trash, settings, sendmsg ]";
                }
                break;
